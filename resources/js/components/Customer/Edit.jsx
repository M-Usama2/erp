...
const Edit = ({ token }) => {
        ...
        axios({
            ...
            .then(async function (response) {
                if (await response.data) {
                    ...
                    setCountry(response.data.customer.country);
                    setZip(response.data.customer.zip);
                    setLoading(false); 
                }
    ...
    const [customer, setCustomer] = useState(fetchCustomer);
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <Link style={{ fontSize: '13px', color: '#9a8888' }} to="/customers">
                        Customers
                    </Link>
                </Breadcrumbs>

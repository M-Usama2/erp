...
function List({ hotels, token, fecthData, role , permission }) {
    ...
    return (
        <div className='contain-table'>
            <div style={{ marginTop: '30px', fontWeight: '200', fontSize: '18px', color: 'white', backgroundColor: '#4b8df8', width: '100%', padding: '7px 15px' }}>
                <BusinessCenterIcon style={{ fontSize: '20px', }} /> Hotel List
            </div>
                    ...
                    <Table sx={{ minWidth: '100%' }} size="small" aria-label="roles List">
                        ...
                        <TableBody>
                            {hotels.length > 0 ? (
                                hotels.map((hotel, i) => (
                                    <TableRow key={hotel.id}>
                                        ...
                                        <TableCell className="text-left">
                                                ...
                                                <button
                                                onClick={() => openDeleteDialog({ id: hotel.id })}
                                ...
                                <TableRow>
                                    <TableCell colSpan={7}>No Hotels</TableCell>
                                </TableRow>
                            )}
                        </TableBody>
                    </Table>
            ...
            <DeleteDialog
                title='Delete?'
                content={`Do you wish to delete Hotel ${deleteId ? deleteId.id : null}`}
                titleYes='Delete'
                open={openDelete}
                handleAction={() => {

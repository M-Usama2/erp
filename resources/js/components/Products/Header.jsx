...
const checkPermission = (name) => role.includes("super-admin") || permission.includes(name);
  ...
  return (
    <header >
        <p style={{fontWeight: '300', fontSize: '40px'}}>Product/Service</p>
        ...
        <div >
          {checkPermission("add product category") ? (
            ...
            <Link className='' style={{display: 'flex',alignItems: 'center', fontSize: '14px',borderRadius: 'none','background': '#35aa47', 'color': "white", "padding": "7px 20px", 'textDecoration': 'none'}} to={'/products/add'}>Add Product/Service <ControlPointIcon style={{padding: '3px'}} /></Link>
            ) : null}

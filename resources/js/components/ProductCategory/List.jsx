...
function List({ productCategory, token, fecthData, role , permission }) {
    ...
    return (
        <div className='contain-table'>
            <div style={{ marginTop: '30px', fontWeight: '200', fontSize: '18px', color: 'white', backgroundColor: '#4b8df8', width: '100%', padding: '7px 15px' }}>
                <BusinessCenterIcon style={{ fontSize: '20px', }} /> Product Category List
            </div>
                    ...
                    <Table sx={{ minWidth: '100%' }} size="small" aria-label="roles List">
                        ...
                        <TableBody>
                            {productCategory.length > 0 ? (
                                productCategory.map((category, i) => (
                                    <TableRow key={category.id}>
                                        ...
                                        <TableCell className="text-left">
                                                ...
                                                <Link
                                                to={`/productCategories/edit/${category.id}`}
                                                ...
                                                <button
                                                onClick={() => openDeleteDialog({ id: category.id })}
                                ...
                                <TableRow>
                                    <TableCell colSpan={7}>No Product Category</TableCell>
                                </TableRow>
                            )}
                        </TableBody>
                    </Table>

...
function Header({ setPayHeads, role, permission }) {
    ...
    return (
        <header >
            <p style={{ fontWeight: '300', fontSize: '40px' }}>PayHead</p>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div>
                    {checkPermission("add payhead") ? (

                    <Link className='' style={{ display: 'flex', alignItems: 'center', fontSize: '14px', borderRadius: 'none', 'background': '#35aa47', 'color': "white", "padding": "7px 20px", 'textDecoration': 'none' }} to={'/payheads/add'}>Add New PayHead <ControlPointIcon style={{ padding: '3px' }} /></Link>
                    ) : null}

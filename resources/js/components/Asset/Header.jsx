...
function Header({ setIsAdding, setAssets }) {

    const Temp = async (e) => {
        let key = e.target.value;
        let result = await fetch(`/api/assets/${key}`);
    ...
    return (
        <header >
            <p style={{ fontWeight: '300', fontSize: '40px' }}>Asset</p>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div >
                    <Link className='' style={{ display: 'flex', alignItems: 'center', fontSize: '14px', borderRadius: 'none', 'background': '#35aa47', 'color': "white", "padding": "7px 20px", 'textDecoration': 'none' }} to={'/assets/add'}>Add New Asset <ControlPointIcon style={{ padding: '3px' }} /></Link>

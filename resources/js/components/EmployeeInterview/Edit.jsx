            ...
            <Box sx={{ width: 1 }}>
                ...
                <Box>
                    <Tabs TabIndicatorProps={{
                        ...
                        <Tab className='tab-style' label="Interview" />
                ...
                <Box sx={{ padding: 2 }}>
                    {tabIndex === 0 && (
                        <Box>
                            <Interview reRender={renderEmployee} employeeId={data.id} listing={data.interviews} />
                        </Box>
                    )}
                    {tabIndex === 1 && (
                        <Box>
                            <div style={{ width: '90%', border: '1px solid #4b8df8', padding: '0px', }}>
                                <div style={{ background: '#4b8df8', height: '60px', color: 'white', display: 'flex', alignItems: 'center', padding: '30px' }}>
                                    <h6 className='text-center'>UPDATE CANDIDATE</h6>
                                </div>

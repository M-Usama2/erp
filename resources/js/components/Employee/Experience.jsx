...
import EditExpereince from './forms/EditExpereince';
...
function Experience({ listing, employeeId, reRender, token }) {
    ...
    return (
        <div style={{ width: '90%', border: '1px solid #4b8df8', padding: '0px', }}>
                                ...
                                <TableCell>
                                    <IconButton onClick={() => {
                                        ...
                                        setData({
                                            ...
                                            start_date: exp.start_date_db,
                                            end_date: exp.end_date_db,
            ...
            <EditExpereince data={data} token={token} reRender={reRender} exp_id={expId} open={openEdit} handleClose={handleCloseEdit} />
